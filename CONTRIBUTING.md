...
Welcome to `scranpy` contributor's guide.
...
If you experience bugs or general issues with `scranpy`, please have a look
...
You can help improve `scranpy` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`scranpy` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `scranpy`'s files. While this mechanism can
...
```
conda create -n scranpy python=3 six virtualenv pytest pytest-cov
conda activate scranpy
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/scranpy.git
   cd scranpy
   ```
...
5. Install [pre-commit]:
   ...
   `scranpy` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/scranpy
[issue tracker]: https://github.com/<USERNAME>/scranpy/issues
