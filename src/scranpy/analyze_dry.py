...
def __dry_analyze(options: AnalyzeOptions=AnalyzeOptions()) -> str:
    ...
    __commands.append('results.quality_control.filtered_cells = scranpy.quality_control.filter_cells(ptr, filter=results.quality_control.qc_filter)')
    __commands.append('results.normalization.log_norm_counts = scranpy.normalization.log_norm_counts(results.quality_control.filtered_cells, options=options.normalization.log_norm_counts)')
    __commands.append('results.feature_selection.gene_variances = scranpy.feature_selection.model_gene_variances(results.normalization.log_norm_counts, options=options.feature_selection.model_gene_variances)')
    ...
    __commands.append('results.dimensionality_reduction.pca = scranpy.dimensionality_reduction.run_pca(results.normalization.log_norm_counts, options=options.dimensionality_reduction.run_pca)')
    ...
    __commands.append('results.marker_detection.markers = scranpy.marker_detection.score_markers(results.normalization.log_norm_counts, grouping=results.clustering.clusters, options=options.marker_detection.score_markers)')
