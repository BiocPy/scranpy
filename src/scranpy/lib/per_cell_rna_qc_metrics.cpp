...
//[[export]]
void per_cell_rna_qc_metrics(const void* mat, int32_t num_subsets, const uintptr_t* subset_ptrs, double* sum_output, int32_t* detected_output, uintptr_t* subset_output, int32_t num_threads) {
