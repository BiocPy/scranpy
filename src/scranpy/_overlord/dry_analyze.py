...
def dry_analyze(options: AnalyzeOptions=AnalyzeOptions()) -> str:
    ...
    __commands.append('rna_options = copy.deepcopy(options.per_cell_rna_qc_metrics_options)')
    ...
    __commands.append('normed = scranpy.normalization.log_norm_counts(filtered, options=options.log_norm_counts_options)')
    ...
    __commands.append('results.tsne_out = get_tsne()')
    __commands.append('results.umap_out = get_umap()')
    return '\n'.join(__commands)
