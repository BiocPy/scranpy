...
def choose_hvgs(stat: np.ndarray, number: int = 2500) -> np.ndarray:
    ...
    Args:
        stat (np.ndarray): Array of variance modelling statistics,
            ...
            mean-variance trend.
        number (int): Number of HVGs to pick.

    Return:
        Array of booleans of length equal to `stat`, specifying whether a given
        gene is considered as highly variable.
    """
