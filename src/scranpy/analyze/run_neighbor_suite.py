...
def run_neighbor_suite(
    ...
    Args:
        ...
        build_neighbor_index_options (BuildNeighborIndexOptions, optional): Optional arguments to pass
            to :py:meth:`~scranpy.nearest_neighbors.build_neighbor_index.build_neighbor_index`.
